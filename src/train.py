...
if __name__ == '__main__':
    ...
    parser.add_argument("-temp_result_dir", default='../temp')
    ...
    parser.add_argument('-ent_num', default=300, type=int)
    parser.add_argument('-graph_hdim', default=768, type=int)
    parser.add_argument('-graph_drop', default=0.2, type=float)
    parser.add_argument('-graph_encoder_drop', default=0.2, type=float)
    parser.add_argument('-graph_encoder_head', default=4, type=int)
    parser.add_argument("-gate", type=str2bool, nargs='?',const=True,default=False)

    parser.add_argument('-lstm_drop', default=0.2, type=float)
